...
<body class=" text-[#1b1b18] flex p-0 lg:p-0 items-center lg:justify-center min-h-screen flex-col">
    <header
        class=" w-[90%] md:w-full fixed  flex flex-wrap items-center shadow-2xl backdrop-blur-2xl rounded-3xl px-5 justify-between z-50 py-2 top-5 lg:max-w-4xl max-w-7xl text-sm mb-6 not-has-[nav]:hidden">
        <a href="{{ route('get.started')}}"
            class="logo decoration-0 text-[#ffff] flex justify-start items-center gap-3">
        ...
        <nav class="flex items-center text-[#ffff] justify-end gap-4 ">
            <a href="{{ route('welcome')}}"
                class="inline-block px-5 py-3 hover:text-[#ee8edb] cursor-pointer  text-sm leading-normal">
                Home
            </a>
            ...
            <a
                class="inline-block px-5 py-3 bg-[#874179] rounded-3xl font-semibold hover:bg-[#44273e] cursor-pointer  text-sm leading-normal">
                About
            </a>
    ...
    <div
        class="flex relative  items-center justify-center  w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
        {{-- background image --}}
         <div class="background absolute  z-0 w-full top-0 h-screen ">
            <img src="{{ asset('images/background2.jpg')}}" class=" -z-10 object-cover w-full h-[114vh] md:h-screen"
                alt="">
        </div>
        ...
        <div class="div bg-black/60 z-30 md:h-screen pt-40 md:pt-0 flex flex-col justify-center items-center w-full">
            ...
            <main
                class="flex max-w-5xl z-20 gap-5 pt-30 md:pt-10  w-full justify-center  items-center text-gray-200 flex-col md:flex-row ">
            </main>

            <main
                class="flex max-w-5xl h-full mt-30 z-20 gap-5 md:pt-10  w-full justify-center  items-center text-gray-100 flex-col md:flex-row ">
                <p
                    class="mb-2 mt-3 w-[90%] max-w-5xl text-shadow-black text-shadow-2xs font-semibold text-2xl md:text-4xl text-center  ">
            ...
            {{-- buttons section --}}
            <main
                class=" flex max-w-4xl  z-20 gap-5 mb-5 pt-10 md:pt-0  w-full justify-center  items-top text-gray-200 flex-col md:flex-row ">

                <div
                    class=" flex-1 mx-auto  text-[30px] w-[90%] md:w-[40%] border-2 border-amber-50/20 hover:border-[#962980]/80  transition delay-75  p-6 backdrop-blur-xl  text-[#ffffff] shadow-2xl  rounded-2xl">
                    <h1 class="mb-1 text-2xl  font-bold">Mentors DashBoard</h1>
                    <p class="mb-2 mt-3 text-sm  text-gray-200">
                        Tiyambe Ntchito: Empowerment starts with a single step. Step inside to lead the change. Dive
                        into the Dashboard
                    </p>
            ...
            {{-- footer --}}
            <p class=" flex text-sm text-center justify-center text-gray-300 w-full py-2"> &copy; 2026
                Tithandizane-women-hub . All rights reserved </p>
        </div>
    </div>
