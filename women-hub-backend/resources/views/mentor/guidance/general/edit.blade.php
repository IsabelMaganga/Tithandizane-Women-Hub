...
@section('title') Edit General Content @endsection
...
<div class="max-w-4xl px-4 py-0 mx-auto sm:px-6 lg:px-8">
    <div class="mt-10 mb-4">
        ...
        <h1 class="mt-4 text-3xl font-semibold text-gray-900">Edit General Issues Content</h1>
    </div>
    ...
    <div class="p-6 bg-white rounded-lg shadow">
        <form action="{{ route('mentor.general.update', $content->id) }}" method="POST" enctype="multipart/form-data">
            @csrf @method('PUT')
            <div class="space-y-6">
                <div>
                ...
                <div>
                    ...
                    <span class="inline-block mt-2 px-3 py-1 text-sm text-white rounded-full {{ $content->status === 'published' ? 'bg-green-600' : 'bg-amber-500' }}">
